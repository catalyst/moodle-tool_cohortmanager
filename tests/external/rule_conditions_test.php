...
use tool_cohortmanager\condition;
...
class rule_conditions_test extends externallib_advanced_testcase {
    ...
    public function test_get_conditions_for_rule() {
        ...
        $condition3 = new condition(0, (object)['ruleid' => $rule->get('id'), 'classname' => 'test', 'position' => 2]);
        $condition3->save();
        ...
        $this->assertSame(0, $conditions[$condition1->get_record()->get('id')]['position']);
        $this->assertSame(
            'tool_cohortmanager\tool_cohortmanager\condition\cohort_membership',
        ...
        $this->assertSame(1, $conditions[$condition2->get_record()->get('id')]['position']);
        $this->assertSame(
            'tool_cohortmanager\tool_cohortmanager\condition\user_profile',
        ...
        $this->assertSame(2, $conditions[$condition3->get('id')]['position']);
